		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Escalation Matrix - By Esi Project",
									"targetURL": "#zescesiproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zescesiproject-display": {
								"semanticObject": "zescesiproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zescesiproject",
									"url": sap.ui.require.toUrl("zescesiproject")
								}
							}
						}
					}
